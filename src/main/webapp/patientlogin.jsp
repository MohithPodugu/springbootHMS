...
<head>
    ...
    <title>Patient Login - MiniCare</title>
    <style>
        /* General Reset */
        * {
            margin: 0;
...
<body>
    ...
    <div class="main-container">
        <div class="login-container">
            <h2>Patient Login to MiniCare</h2>
            <p>Welcome back! Please enter your credentials to access your account.</p>
            
            <!-- Corrected single form element -->
            <form method="post" action="checkpatientlogin">
                <input type="text" name="pemail" placeholder="Username or Email" required>
