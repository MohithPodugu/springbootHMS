...
<head>
    ...
    <title>Doctor Login - MiniCare</title>
    <style>
        /* General Reset */
        * {
            margin: 0;
...
<body>
    ...
    <div class="main-container">
        <div class="login-container">
            <h2>Doctor Login to MiniCare</h2>
            <p>Welcome back! Please enter your credentials to access your account.</p>

            <!-- Corrected single form element -->
            <form method="post" action="checkdoclogin">
                <input type="text" name="demail" placeholder="Username or Email" required>
